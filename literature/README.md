...
### affective-design - 情感设计
情感计算、情感化设计、玩家情感体验相关研究

### transformational-games - 变革性游戏
反思性游戏、自传体游戏、体验转化相关研究

### hci-player-experience - HCI与玩家体验
人机交互、用户体验、玩家体验设计

### design-research - 设计研究方法
Research through Design、设计型研究、实践型知识贡献

## 文献记录格式

每篇文献笔记包含以下字段：
- **基本信息**：标题、作者、年份、出处、DOI/链接
- **核心论点**：文章的主要贡献和观点
- **方法论**：研究采用的方法
- **与本研究的相关性**：如何支撑"来自生活的游戏设计"方法论
- **可引用内容**：关键段落或观点
- **后续行动**：获取全文、深入阅读章节等

## 文献总览表

| 标题 | 作者 | 年份 | 领域 | 相关度 | 状态 | 文件链接 |
|------|------|------|------|--------|------|----------|
| Rules of Play: Game Design Fundamentals | Salen & Zimmerman | 2003 | 游戏设计基础 | ⭐⭐⭐⭐⭐ | 已建笔记，需精读页码 | [foundational/salen-rules-of-play.md](./foundational/salen-rules-of-play.md) |
| Emotion Design for Video Games: A Framework for Affective Interactivity | Croissant, Schofield & McCall | 2023 | 情感设计 | ⭐⭐⭐⭐⭐ | 元数据已校准，需精读全文 | [affective-design/emotion-design-framework.md](./affective-design/emotion-design-framework.md) |
| A Design Framework for Reflective Play | Miller et al. | 2024 | 反思性游戏 | ⭐⭐⭐⭐⭐ | 元数据已校准，可支撑反思性机制 | [transformational-games/reflective-play-framework.md](./transformational-games/reflective-play-framework.md) |
...
| 标题 | 作者 | 年份 | 建议用途 |
|------|------|------|----------|
| The Game Design Reader | Salen & Zimmerman (Eds.) | 2005 | 游戏研究经典文集，补充历史与理论脉络 |
| Art as Experience | Dewey | 1934 | 支撑"艺术源于日常经验" |
| Researching Lived Experience | van Manen | 1990 | 支撑 lived experience 的现象学方法 |
